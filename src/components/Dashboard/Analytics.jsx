  ...
  return (
    <div className="container mx-auto">
      ...
      {activeTab === 'focus' && (
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
            ...
            <div className="mt-4">
              <h4 className="text-md font-medium text-gray-700 mb-3">Focus Time by Day</h4>
              <div className="h-80">
                <Bar 
                  data={focusTrendData} 
                  options={{
      ...
      {activeTab === 'trends' && (
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
            <h3 className="text-lg font-medium text-gray-800 mb-4">Task Completion Trends</h3>
            
            <div className="mb-6">
              <h4 className="text-md font-medium text-gray-700 mb-3">Completion Rate (Last 7 Days)</h4>
              <div className="h-80">
                <Line 
            ...
            <div className="mt-8">
              <h4 className="text-md font-medium text-gray-700 mb-3">Daily Task Completion</h4>
              <div className="overflow-x-auto">
                {(() => {
                  const tableDisplayDates = [...trendData.dates].reverse();
                  const tableDisplayTaskData = [...trendData.taskCompletionData].reverse();
                  const tableDisplayFocusData = [...trendData.focusTimeData].reverse();

                  const tableRows = tableDisplayDates.map((date, i) => (
                    <tr key={date} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{date}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{tableDisplayTaskData[i].total}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{tableDisplayTaskData[i].completed}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <div className="flex items-center">
                          <div className="w-full max-w-[100px] bg-gray-200 rounded-full h-2 mr-2">
                            <div
                              className="bg-blue-600 h-2 rounded-full"
                              style={{width: `${tableDisplayTaskData[i].completionRate}%`}}
                            ></div>
                          </div>
                          <span>{tableDisplayTaskData[i].completionRate}%</span>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {formatMinutes(tableDisplayFocusData[i].minutes * 60)}
                      </td>
                    </tr>
                  ));
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      <thead className="bg-gray-50">
                        <tr>
                          ...
                          <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Focus Time</th>
                        </tr>
                      </thead>
